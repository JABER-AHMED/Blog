    ...
    <div class="grid_10">
        <div class="box round first grid">
            ...
            <div class="block">  
				...
				$query = "SELECT table_post.*, table_category.name FROM table_post INNER JOIN table_category
					ON table_post.cat = table_category.id
					ORDER BY table_post.title DESC";
